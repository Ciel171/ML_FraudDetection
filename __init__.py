...
class ML_Fraud:
    ...
    def RUS_2003(self, C_FN=30, C_FP=1):
        """
    ...
    def AppendixE_excluding_missing_values(self, C_FN=30, C_FP=1):
        ...
        WARNING!:
        1) For Panel A of Appendix E where missing values are included, please change the dataset being used
